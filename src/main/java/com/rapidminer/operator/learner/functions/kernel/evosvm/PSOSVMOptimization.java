...
public class PSOSVMOptimization extends PSOOptimization {
	...
	public PSOSVMOptimization(
			ExampleSet exampleSet, // training data
			Kernel kernel,
			double c, // double epsilon, // SVM paras
			int maxIterations,
			int generationsWithoutImprovement, // convergence
												// paras
		...
		super(popSize < 1 ? exampleSet.size() : popSize, exampleSet.size(), maxIterations, generationsWithoutImprovement,
				inertiaWeight, localWeight, globalWeight, 0.0d, 1.0d, dynamicInertiaWeight, random);
