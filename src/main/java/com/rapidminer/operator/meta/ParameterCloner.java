 ...
 * {@link com.rapidminer.operator.io.ParameterSetLoader}. This operator is useful, e.g. in the
						...
						if (parts.length != 2) {
							...
							addError(new SimpleProcessSetupError(Severity.ERROR, this.getPortOwner(),
									Collections.singletonList(new ParameterSettingQuickFix(this, PARAMETER_NAME_MAP,
											getParameterAsString(PARAMETER_NAME_MAP))), "parameter_wrong_format",
									PARAMETER_NAME_MAP));
							break;
						} else {
							if (!operatorNames.contains(parts[0])) {
								...
								addError(new SimpleProcessSetupError(Severity.ERROR, this.getPortOwner(),
										Collections.singletonList(new ParameterSettingQuickFix(this, PARAMETER_NAME_MAP,
												getParameterAsString(PARAMETER_NAME_MAP))), "parameter_unknown_operator",
										PARAMETER_NAME_MAP, parts[0]));
							} else {
								...
								if (type == null) {
									...
									addError(new SimpleProcessSetupError(Severity.ERROR, getPortOwner(),
											Collections.singletonList(new ParameterSettingQuickFix(this, PARAMETER_NAME_MAP,
													getParameterAsString(PARAMETER_NAME_MAP))),
