...
public abstract class AbstractAggregationFunction implements AggregationFunction {
	...
	public static final Class[] KNOWN_AGGREGATION_FUNCTIONS = { AverageFunction.class, VarianceFunction.class,
			StandardDeviationFunction.class, CountFunction.class, MinFunction.class, MaxFunction.class, SumFunction.class,
			ModeFunction.class, MedianFunction.class, ProductFunction.class };
	...
	public static AggregationFunction createAggregationFunction(int typeIndex) throws InstantiationException,
